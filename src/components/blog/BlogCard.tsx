  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        {post.excerpt && (
          <p className="text-white/50 text-sm line-clamp-2 mb-4 font-body">{post.excerpt}</p>
        )}
          ...
          <div className="relative z-10 flex flex-wrap gap-1.5 mb-4">
            {post.tags.slice(0, 4).map((tag) => (
              <Link
                ...
                className="px-2 py-0.5 bg-white/5 hover:bg-white/10 text-xs font-mono text-white/40 hover:text-white/70 transition-colors rounded-full"
              >
                #{tag}
              </Link>
            ))}
