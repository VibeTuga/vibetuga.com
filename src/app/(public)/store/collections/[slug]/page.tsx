  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <section className="mb-12">
        ...
        {!collection.coverImage && (
          <h1 className="text-4xl md:text-5xl font-black font-headline tracking-tighter text-white mb-4">
            {collection.name}
          </h1>
        )}
      ...
      {collection.products.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <h2 className="font-headline text-2xl font-bold text-white mb-2">Coleção vazia</h2>
          <p className="text-white/40 text-sm max-w-md">Esta coleção ainda não tem produtos.</p>
        </div>
      )}
    </div>
  );
