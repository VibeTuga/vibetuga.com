    ...
    <div className="min-h-[50vh] flex items-center justify-center px-6">
      <div className="max-w-[500px] w-full text-center">
        ...
        <div className="bg-[#131313] border border-red-500/20 px-4 py-2 mb-6 flex items-center gap-2 font-mono text-xs text-red-400/80">
          ...
          <span>ADMIN_RUNTIME_ERROR</span>
          {error.digest && (
            <span className="ml-auto text-white/20 text-[10px]">#{error.digest}</span>
          )}
        </div>

        <h2 className="font-headline text-2xl font-black text-white uppercase tracking-tight mb-3">
          Erro no painel de administração
        </h2>
        <p className="text-white/40 text-sm font-mono mb-2">
          {error.message || "Ocorreu um erro inesperado na área de administração."}
        </p>
        <p className="text-white/20 text-xs font-mono mb-8">
          Se o erro persistir, contacta o suporte técnico.
        </p>
