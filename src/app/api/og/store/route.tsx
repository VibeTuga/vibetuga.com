...
export async function GET(request: NextRequest) {
  ...
  const title = searchParams.get("title") || "VibeTuga Store";
  const seller = searchParams.get("seller") || "VibeTuga";
