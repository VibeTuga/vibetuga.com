...
--> statement-breakpoint
ALTER TABLE "blog_series" ADD CONSTRAINT "blog_series_author_id_user_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
